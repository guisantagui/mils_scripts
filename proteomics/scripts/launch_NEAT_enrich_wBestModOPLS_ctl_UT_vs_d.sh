...
########################################################################################################################
DE_file="/home/users/gsantamaria/projects/cureMILS/proteomics/results/DE/proteom_log2_OPLS_ctl_UT_vs_d_bestMod_resSign.csv"
outNameNEAT="proteom_log2_ctrl_UT_vs_d_oplsBestMod_neat.csv"
conv2ENSEMBL=true
