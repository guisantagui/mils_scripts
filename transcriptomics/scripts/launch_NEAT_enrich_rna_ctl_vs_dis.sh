...
########################################################################################################################
DE_file="/home/users/gsantamaria/projects/cureMILS/transcriptomics/results/DE/DEG_no_mutation_to_mutation_only_05.xlsx"
outNameNEAT="DEG_no_mutation_to_mutation_only_05_neat.csv"
conv2ENSEMBL=true
...
# Run NEAT
Rscript NEAT_enrich.R --DE $DE4NEAT --outName $outNameNEAT --FCFile $FCFile --saveUsedFeats
